...
int main()
{
    ...
    string eulerNumberString = "27182818284590452353602874713526624977572470936999595749669676277240766303535475945713821785251664274";
    string div = "1";
    int i, j, cnt;
    for (i = 1; i <= 100; i++) {
        div += '0';
    ...
    //cout << div << endl;
    BigInt eulerNumber, cns, sum, tmp, dv;
    eulerNumber = Integer(eulerNumberString);
    dv = Integer(div);
    string n;
    cin >> n;
    BigInt N = Integer (n);
